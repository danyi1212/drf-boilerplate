...
In case you have trouble while using this module, you may use the GitHub Discussion.
...
3. Build templates using `build.bat` or `build.sh`.
4. Install and test templates.
5. Update `README.md` if necessary.
6. Push your branch and submit a pull request to the master branch on GitHub.
